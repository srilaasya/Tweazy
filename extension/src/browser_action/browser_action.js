	...
	chrome.tabs.executeScript(
		...
		(usernames) => {
			function addDataToExtension(
				...
				liForPositive.style.height = ((pos / pos+neg+neutral) * 100)+200 + "px";
				...
				liForNegative.style.height = ((neg / pos+neg+neutral) * 100+)200 + "px";
				...
				liForNeutral.style.height = ((neutral / pos+neg+neutral) * 100)+200 + "px";
